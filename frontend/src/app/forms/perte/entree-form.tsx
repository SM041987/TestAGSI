...
const accountFormSchema = z.object({
  ...
  numeroinventaire: z.string().nonempty({
    message: "Numero d'ordre de l'inventaire is required.",
  }),
  designation: z.string().nonempty({
    message: "Designation de l'objet is required.",
  }),
  Type: z.string().nonempty({
    message: "Type du procès verbal is required.",
  }),
  justification: z.string().nonempty({
    message: "Numero procès verbal is required.",
  }),
  prix: z.string().nonempty({
    message: "Prix unité is required.",
  }),
  montant: z.string().nonempty({
    message: "Montant total is required.",
  }),
    ...
    <Form {...form}>
      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              Type du procès verbale
              <Select>
                <SelectTrigger className="w-[240px]">
                  <SelectValue placeholder="Perte||détorioration" />
                </SelectTrigger>
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value="Perte">Perte</SelectItem>
                    <SelectItem value=" detorioration">
                      {" "}
                      Détorioration
                    </SelectItem>
                  </SelectGroup>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="w-[240px]">
              <FormLabel>Numero procès verbale</FormLabel>
              <FormControl>
        ...
        <Button type="submit" className=" w-[240]">
          Eregistrer la dans le registre
        </Button>
      </form>
    </Form>
  );
